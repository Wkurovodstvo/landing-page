    ...
    render() {
        ...
        return(
            <nav className={navClass}>
                <a href={"#work"} className={"TopMenu-nav__nav-link hide-mobile"}>Our Work</a>
                <a href={"#process"} className={"TopMenu-nav__nav-link hide-mobile"}>Process</a>
                <a href={"#home"} className={"TopMenu-nav__nav-link TopMenu-nav__nav-image"}>
                    <img src={Logo} alt={"Logo"}/>
                </a>
                <a href={"#features"} className={"TopMenu-nav__nav-link hide-mobile"}>Features</a>
                <a href={"#pricing"} className={"TopMenu-nav__nav-link hide-mobile"}>Pricing</a>
